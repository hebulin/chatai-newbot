...
@Service
public class OfficialDeepSeekV3Service {
    private final AIConfig aiConfig;
    private final WebClient webClient;
    private static final Logger log = LoggerFactory.getLogger(OfficialDeepSeekV3Service.class);

    public OfficialDeepSeekV3Service(AIConfig aiConfig) {
    ...
    public Flux<String> chat(ChatRequest request) {
        request.setModel(aiConfig.getDeepseekModel());
